...
data class SupportPerformanceSnapshot(
    ...
    val authenticatedAggressiveCdnEnabled: Boolean,
...
data class SupportSettingsSnapshot(
    ...
    val autoCheckDownloadedModUpdatesOnLaunch: Boolean,
    ...
    val requestedChunkConcurrency: Int,
    val primordialReducedMemoryProtectionEnabled: Boolean,
    val primordialAuthenticatedAggressiveCdnEnabled: Boolean,
    val workshopPageSize: Int,
    val workshopAutoResolveVisibleItems: Boolean,
    val animatedWorkshopPreviewEnabled: Boolean,
    val terrariaArchivePostProcessorEnabled: Boolean,
    val terrariaArchiveKeepOriginal: Boolean,
    val wallpaperEnginePkgExtractEnabled: Boolean,
    val wallpaperEnginePkgKeepOriginal: Boolean,
    val wallpaperEngineTexConversionEnabled: Boolean,
    val wallpaperEngineKeepConvertedTexOriginal: Boolean,
